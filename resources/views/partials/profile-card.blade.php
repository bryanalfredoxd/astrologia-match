<div class="bg-gradient-to-r from-[#4A0E7B] to-[#1A1F4D] rounded-2xl p-6 md:p-8 mb-6 shadow-lg relative overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col md:flex-row items-center md:items-start w-full">
        ...
        <button id="calculateGroqAstrology" class="absolute top-4 right-4 sm:top-6 sm:right-6 text-[#FFD700] hover:text-white transition-colors duration-200 p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-[#FFD700]">
